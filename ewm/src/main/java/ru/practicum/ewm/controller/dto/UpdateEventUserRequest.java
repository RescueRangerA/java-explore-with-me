...
public class UpdateEventUserRequest {
    ...
    public UpdateEventUserRequest participantLimit(Long participantLimit) {
    ...
    @Schema(name = "stateAction", example = "CANCEL_REVIEW", description = "Изменение состояния события", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
